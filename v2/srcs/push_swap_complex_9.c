...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   push_swap_complex_9.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: jacher <marvin@42.fr>                      +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/03/11 15:35:55 by jacher            #+#    #+#             */
/*   Updated: 2021/05/13 19:02:59 by jacher           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../sort.h"

int			special_9_a(t_d *d, t_list **l)
{
	int ref;
	...
	if (d->a[ref].nb < d->a[ref + 1].nb
		...
		&& d->a[ref + 6].nb < d->a[ref + 7].nb
		&& d->a[ref + 7].nb < d->a[ref + 8].nb)
		return (1);
...
int			special_8_b(t_d *d, t_list **l)
{
	...
	if (d->b[ref + 3].nb > d->b[ref + 4].nb
		...
		&& d->b[ref + 6].nb > d->b[ref + 7].nb
		&& d->b[ref + 7].nb > d->b[ref + 8].nb)
	{
